  ...
  return (
    <div className="mx-auto grid max-w-4xl gap-8 py-6 lg:grid-cols-[1fr_1.1fr] lg:items-center lg:py-14">
      <section className="fade-up">
        <div className="eyebrow">Optional sign-in</div>
        <h1 className="mt-2 text-3xl font-semibold tracking-tight text-fg md:text-4xl">Your own view of the desk</h1>
        <p className="mt-3 max-w-md text-sm leading-relaxed text-muted">
          The book, tape, and idea pages are open to everyone. Signing in adds a personal workspace — nothing here is
          required to read the research.
        </p>
        <ul className="mt-6 space-y-3 text-sm text-fg-2">
          ...
          <li className="flex items-start gap-3">
            ...
            <span>
              <strong className="font-medium text-fg">No passwords</strong> — Google, GitHub, or a one-time email link. We
              store your email, name, and preferences; nothing else.
            </span>
          </li>
        </ul>
      </section>
        ...
        <div className="mt-6 space-y-3">
          ...
          {providers && providers.length === 0 ? (
            <Alert tone="warning" title="Sign-in is not configured">
              No identity providers are set on this server. Set <code className="mono">AUTH_GOOGLE_*</code>,{" "}
              <code className="mono">AUTH_GITHUB_*</code>, or <code className="mono">AUTH_RESEND_KEY</code> and restart.
            </Alert>
          ) : null}
        </div>
